...
<div class="container-fluid">
    ...
    <div class="col-xl-3 col-md-6 mb-4">
        ...
        <div class="card-body">
            <div class="row no-gutters align-items-center">
            <div class="col mr-2">
                <div class="text-xs font-weight-bold text-warning text-uppercase mb-1">User Registered</div>
    ...
    <div class="col-xl-8 col-lg-7">
        ...
        <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
            ...
            <div class="dropdown-menu dropdown-menu-right shadow animated--fade-in" aria-label  ledby="dropdownMenuLink">
    ...
    <div class="col-xl-4 col-lg-5">
        ...
        <div class="card-body">
            ...
            <span class="mr-2">
                <i class="fas fa-circle text-primary">{{ $user }}</i> 
            </span>
            <span class="mr-2">
                <i class="fas fa-circle text-success">{{ $transaction}}</i>
            </span>
            <span class="mr-2">
                <i class="fas fa-circle text-info"> {{ $travel_package}}</i>
            </span>
            </div>
        </div>
        </div>
